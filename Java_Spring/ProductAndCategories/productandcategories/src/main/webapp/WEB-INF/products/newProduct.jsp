...
<body>
	...
	<div class="mt-2 d-flex justify-content-center">
				...
				<div class="mb-3">
					<form:label class="form-label" for="description" path="description">Add Description : </form:label>
				...
				<div class="mb-3">
					<form:label class="form-label" for="price" path="price">Enter Price : </form:label>
					<form:input type="number" class="form-control" id="price" path="price" />
					<form:errors class="form-text" for="price" path="price" />
				</div>
